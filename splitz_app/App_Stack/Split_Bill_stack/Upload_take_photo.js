...
const Upload_take_photo = () => {
  ...
  const handleScanPress = async () => {
    ...
    if (cameraPermission.granted === false) {
      Alert.alert(
        "Access Denied, Please allow camera access to use this feature!"
      );
      return;
    }
    Keyboard.dismiss();
      ...
      axiosInstance
        ...
        .then((uploadresponse) => {
          ...
          if (room_code) {
            ...
            console.log(
              "Upload receipt successful no room_code: ",
              uploadresponse.data
            );
      ...
      {loading ? (
        <View style={styles.loading_container}>
          ...
          <Text style={styles.loading_text}>
            We are processing your receipt, you will be redirected soon!
          </Text>
        </View>
      ) : (
        <>
          ...
          <KeyboardAvoidingView style={{ flex: 1 }} behavior="height">
            <View style={{ flex: 1 }}>
              <View style={styles.container}>
                <Animated.View
                  style={{ borderBottomWidth: 3, borderColor: Colors.primary }}
                >
                  <TextInput
                    style={[
                      styles.text_input,
                      { color: interpolatedPlaceholderColor },
                    ]}

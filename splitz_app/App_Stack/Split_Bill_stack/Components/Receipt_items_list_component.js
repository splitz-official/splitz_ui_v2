  ...
  return (
    ...
    >
      ...
      <View style={{ flexDirection: "row", alignItems: "center" }}>
        {!readOnly ? null : (
          <View
            style={[styles.checkbox, isSelected ? styles.selectedbox : {}]}
          />
        )}
        {!readOnly ? (
          <>
          ...
          <>
            <View>
              <RegularText numberOfLines={1} style={styles.name}>
                {truncate(name, 15)} {quantity}
              </RegularText>
              {readOnly && participants && participants.length > 0 && (
                <View style={{ alignItems: "center", flexDirection: "row" }}>
                  <RegularText
                    style={{ color: Colors.textgray, fontSize: RFValue(10) }}
                  >
                    {quick ? "Selected for" : "Also selected by"}:{" "}
                  </RegularText>
                  <FlatList
                    data={participants}

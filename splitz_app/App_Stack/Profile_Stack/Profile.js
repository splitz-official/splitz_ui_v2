...
function Profile(props) {
  ...
  const [profile_color, setProfile_color] = useState(
  ...
  const fetchUsers = async () => {
    try {
      ...
      const usersExcludingSelf = response.data.filter(
    ...
    <LinearGradient_background>
      ...
      <View style={[styles.bottom_container, {}]}>
        ...
        <Large_button
          onPress={onShare}
          Iconcomponent={
            <Feather name="share" size={scale(30)} color={Colors.primary} />
          }
        ...
        <View style={styles.modal_centeredView}>
          <View style={styles.modalView}>
            ...
            <View style={styles.modal_buttonsContainer}>
              ...
              <TouchableOpacity style={[styles.modal_buttons]} onPress={logout}>
      ...
      >
        <Screen>
          ...
          <View style={{ flex: 1, marginHorizontal: "6%" }}>
            <TouchableOpacity
              onPress={() => userListSearchRef.current.focus()}
              activeOpacity={1}
              style={styles.friend_search_input_container}
            >
              <FontAwesome
                name="search"
                size={scale(20)}
